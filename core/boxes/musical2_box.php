 ...
 */
class musical2box extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "musical2@musical2";
    public $boxlabel;
    public $depends = array("musical2");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/musical2/class/musical2.class.php";
